...
- ~~**Migration `20260911000000_revalidate_landing_on_publish.sql`** du chantier 1,
  ...
  **En place, mesuré le 17 septembre 2026** en lecture seule : `pg_net` 0.20.0,
  les déclencheurs `bentos_revalidate_landing` et `editions_revalidate_landing`
  actifs, les deux secrets présents, et trois appels réussis le 15 septembre.
...
| 18 | Publication automatique à la validation | Activation | M | 5 | ✅ **4 lots livrés (PR #86, CI verte, fusionnée le 26/09)**, spécifiés, arbitrés, faits et recettés dans la journée, cinq décisions · recettés au simulateur iPhone 17 Pro et à l'émulateur Pixel 8, sur la base locale : la base publie le bento marqué à la validation de son dernier item en attente, le back-office dit « Bento publié », l'app pose la marque et dit « Bientôt en ligne », édition comprise · **migration appliquée en production le 26/09**, prouvée compatible avec la 1.1 et la 0.1.0 avant, lectures des versions publiées inchangées après · **back-office redéployé le 26/09**, battement reçu en 202 juste après · DoD 10 sur 11, la réception de « Bento publié » suivant le 5b du 17, et un vrai téléphone le 29 · mesuré : sur 24 bentos portant une proposition de leur auteur, **15 ne sont jamais sortis**, dont 12 complets, validés le 25 août pour onze d'entre eux ; les 8 autres, 5 jours après la validation en médiane · **tout bento complet sort à la validation de son dernier item**, sans geste, dans la nouvelle app seulement, qui le dit avant et notifie « Bento publié » après · [spec](./UX-18-PUBLICATION-AUTOMATIQUE.md) |
...
- **Les sous-titres d'artistes sont en anglais** (« US · Person », « FR · Person · French rapper ») : données héritées d'anciens imports, à mesurer puis corriger à part. **Mesuré et arbitré le 17 septembre 2026** : 25 artistes, sur 19 des 27 bentos publiés, et des défauts voisins chez les créateurs, les chansons et les lieux. La règle et le correctif de 55 items sont au [§11 de la spécification du catalogue](./MON-BENTO-POP-CATALOG.md#11-sous-titres-septembre-2026). **Appliqué en production le 17 septembre 2026**, vérifié en base et sur la page de dark_hifus.
...
> **Lots 1 à 4 faits et recettés du 17 au 23 septembre 2026, lot 5a le 23, fusionnés le 23 (PR #80) et en service sans destinataire depuis le 26**, cf. [la spécification](./UX-17-NOTIFICATIONS-PUSH.md), qui tient ses décisions, D1 à D28. Le « fait quand » se vérifie en deux temps : au simulateur et à l'émulateur au lot 5b, à l'arrivée de la clé APNs et du compte FCM ; sur appareil réel, en build de production, au chantier 29. Le constat ci-dessous est celui du 15 septembre.
...
> **Spécifié et arbitré le 26 septembre 2026, fait, recetté et livré le même jour**, lots 1 à 4, la migration appliquée en production, la PR #86 fusionnée et le back-office redéployé, cf. [la spécification](./UX-18-PUBLICATION-AUTOMATIQUE.md), qui tient ses décisions, D1 à D5, et sa DoD, 10 points sur 11. Le constat ci-dessous est celui du 15 septembre ; celui de la spécification le mesure.
...
**Fait quand** : quelqu'un qui complète son bento avec un item proposé le voit sortir à la validation, sans rouvrir l'app, et le sait avant comme après. Revu le 26 septembre 2026 : D1 a retiré le geste « Publier » que demandait la première version.
...
### Du chantier 18, publication automatique à la validation

> **Versé le 26 septembre 2026**, au lot 4 : ce que le simulateur et
> l'émulateur ne montrent pas, cf. §10 de
> [la spécification](./UX-18-PUBLICATION-AUTOMATIQUE.md).

- **« Bento publié » sur un vrai iPhone et un vrai Android**, en build de
  production : valider depuis le back-office la proposition qui complète un
  bento, recevoir la notification, la taper, arriver sur la page publique du
  bento. Le tap sur Android se voit dès le lot 5b du chantier 17.
...
et supprime cette liste.~~ **Tranché le 17 septembre 2026 : la recette sur
appareil se fait seulement à la sortie.** Un chantier se fusionne après sa
recette au simulateur et à l'émulateur, et ce qui demande un vrai téléphone
s'ajoute à cette liste.

**Décidé le même jour : ce chantier devient la recette de sortie**, un parcours
complet de tous les chantiers sur iPhone et Android, en build de production,
juste avant la soumission. La sortie store unique attend que la liste soit
vide.

**Fait quand** : la liste est vide, et la recette de sortie est passée sur iPhone et Android en build de production.
