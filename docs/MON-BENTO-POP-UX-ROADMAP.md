...
| 13 | Bento hebdomadaire | Rétention | L | 15, 16 | ⬜ **le suivant** · ses deux dépendances sont levées depuis le 16/09 · reste à trancher : la PK `(bento_id, category_id)` interdit deux cases du même type dans une édition |
