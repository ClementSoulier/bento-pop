...
export default async function PodcastsPage() {
  ...
  const [episodesRes, hostsRes, teamRes] = await Promise.all([
    supabase
      ...
      .select(
        'id, slug, title, description, spotify_episode_id, audio_platform, audio_show_id, thumbnail_url, duration_seconds, published_at, season, episode_number, status, display_order, seo_title, seo_description, guests, mentions, chapters, audio_url, audio_bytes, audio_mime, audio_published_at, feed_guid, feed_season, feed_number, explicit, episode_type, audio_title, audio_description, audio_image_url',
      )
