 ...
 * et `hmtx` ; `extenda-metrics.test.ts` les relit dans le fichier et échoue si
 * la police change. N'y figurent que les caractères qu'un titre en capitales
 * peut afficher : latin, grec, cyrillique, ponctuation et symboles monétaires.
 * Les minuscules en sont absentes, `textTransform: 'uppercase'` ne les rend
 * jamais, et Extenda leur donne d'autres largeurs.
 *
